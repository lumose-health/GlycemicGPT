...
export function MealPhotoPlaceholder({ size = "sm" }: { size?: "sm" | "lg" }) {
  ...
  return (
    <div
      ...
      className={twMerge(
        dimensions,
        "flex shrink-0 items-center justify-center rounded-panel bg-surface-secondary text-foreground-primary",
      )}
