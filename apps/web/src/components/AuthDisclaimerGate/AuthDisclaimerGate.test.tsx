...
describe("V2 AuthDisclaimerGate - Loading State", () => {
...
describe("V2 AuthDisclaimerGate - Acknowledged User", () => {
...
describe("V2 AuthDisclaimerGate - Unacknowledged User", () => {
  beforeEach(() => {
    mockUseUserContext.mockReturnValue({
      user: {
        id: "1",
...
describe("V2 AuthDisclaimerGate - Acknowledgment Flow", () => {
...
describe("V2 AuthDisclaimerGate - Fallback Content", () => {
...
describe("V2 AuthDisclaimerGate - No User", () => {
...
describe("V2 AuthDisclaimerGate - Accessibility", () => {
