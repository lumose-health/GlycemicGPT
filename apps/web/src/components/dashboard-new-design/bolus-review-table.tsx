...
export function BolusReviewTable({ className, unit ="mgdl" }: BolusReviewTableProps) {
  ...
  const periodLabel = dashboardTimeRange?.label ?? BOLUS_PERIOD_LABELS[period] ?? period;
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-signal-partial-fill/10 rounded-lg">
            <ListOrdered className="h-5 w-5 text-signal-partial-text" aria-hidden="true" />
          </div>
          <h2 id="bolus-review-heading" className="text-foreground-primary font_header_4">
            Recent Insulin
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-border-hover">
                <th scope="col" className="px-4 py-2 font_metric_caption text-foreground-secondary">Time</th>
                <th scope="col" className="px-4 py-2 font_metric_caption text-foreground-secondary">Units</th>
                <th scope="col" className="px-4 py-2 font_metric_caption text-foreground-secondary">Type</th>
                <th scope="col" className="px-4 py-2 font_metric_caption text-foreground-secondary">BG</th>
                <th scope="col" className="px-4 py-2 font_metric_caption text-foreground-secondary">IoB</th>
                <th scope="col" className="px-4 py-2 font_metric_caption text-foreground-secondary">Reason</th>
              </tr>
            </thead>
            <tbody>
