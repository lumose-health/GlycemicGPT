...
export function GlucoseUnitSeedNotice() {
  ...
  return (
    <div
      className={clsx("rounded-lg border px-4 py-3 flex items-center justify-between gap-3","bg-signal-info-fill/20 border-signal-info-fill"
      )}
      role="status"
      aria-live="polite"
    ...
    >
      <div className="flex items-center gap-3">
        <Info className="h-5 w-5 text-signal-info-text shrink-0" aria-hidden="true" />
