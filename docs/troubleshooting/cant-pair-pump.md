...
The Tandem Mobi pump uses the same Bluetooth protocol as the t:slim X2, but the platform has not been verified against physical Mobi hardware (see [README](../../README.md) Mobi note for the disclaimer). Pairing with Mobi may work but is at your own risk. If you have a Mobi and successfully pair, please [open an issue in android-unofficial](https://github.com/lumose-health/android-unofficial/issues/new/choose) reporting your experience -- it helps the project understand whether Mobi support is solid in practice.
