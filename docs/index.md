...
| Freestyle Libre 2 / 3 / 3+ | **Native (LibreLinkUp)** | Connect with your LibreLinkUp follower email + password -- no Nightscout required. See [LibreLinkUp](./daily-use/integrations.md#librelinkup). |
