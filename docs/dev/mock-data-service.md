...
The Glucose event tab also controls reading freshness independently from the glucose value. Current keeps the latest reading at the present time. Delayed ages it to seven minutes, and Stale ages it to eleven minutes. The selected freshness is reflected in glucose history, Dexcom integration status, and live stream responses.
